package fr.aj.jeez.servlet.tools;
...
public class MapRefiner {
	...
	//TODO relier attentivement tt repose su ca 
		 ...
		 * @param subKeysTab
		 * @return  */
		public static List<Map<String,String>> branch(Map<String,String> bigMap,String[]subKeysTab){
			Map<String,String> smallMap = new HashMap<>();
