...
public class Lingua {
	...
	static 
	{
		quodWMS.put("fr-FR","[Momento] Bienvenu sur Momento.");
		quodWMS.put("en-GB","[Momento] Welcome on Momento.");
		quodWMM.put("fr-FR","Bienvenu sur Momento. \nMerci de confirmer votre compte en cliquant sur le bouton ci-dessous : \n ");
		quodWMM.put("en-GB","Welcome on Momento.\nPlease, confirm your account by clicking the button below : \n");
		
		quodNAKSS.put("fr-FR","[Momento] Retrouvez l'acces � votre compte.");
		quodNAKSS.put("en-GB","[Momento] Regain access to your account.");		
